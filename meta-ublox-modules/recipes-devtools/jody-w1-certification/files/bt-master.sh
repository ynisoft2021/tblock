...
# 3 ===========================================
viewStep $step "Set server name to \"$module\"..."

hciconfig hci0 name $module  &>/dev/null
if [ $? -ne 0 ]
then
    myExit $step  "can not set master name"
fi
viewSuccess

# 4 ===========================================
viewStep $step "Start bluetooth server..."
...
if [ $? -ne 0 ]
then
    myExit $step  "Start master failed."
fi

viewSuccess

echo -e "[$pid] press Enter to stop the server "
read qwe
