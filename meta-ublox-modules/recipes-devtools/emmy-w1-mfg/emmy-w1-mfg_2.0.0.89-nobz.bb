...
PR = "r3"
PV = "2.0.0.89-15.2.7.p69-nobz"
PVM = "2.0.0.89-15.2.7.p69"
...
SRC_URI = " \
    ${LULA_DL_URL}/MFG-W8887-MF-WIFI-BT-FM-BRG-FC-WIN-X86-${PVM}.zip${LULA_DL_PARAMS};name=mfgbundle \
    file://${PV}/0001-use-MARVELL_BT_STACK-possibility.patch \
    file://load-modules.sh \
    file://unload-modules.sh \
    file://emmy-w1-mfgbridge \
    file://emmy-w1-mfgbridge-sdiosdio \
    file://${PV}/mrvl-sd8887.conf \
"
...
S = "${WORKDIR}/MFG-W8887-MF-WIFI-BT-FM-BRG-FC-WIN-X86-${PVM}/MFG-W8887-MF-WIFI-BT-FM-BRG-FC-WIN-X86-${PVM}-bin"
...
do_install() {
    ...
    install -m 0644 ${WORKDIR}/${PV}/mrvl-sd8887.conf ${D}${sysconfdir}/modprobe.d/${PN}.conf
}
