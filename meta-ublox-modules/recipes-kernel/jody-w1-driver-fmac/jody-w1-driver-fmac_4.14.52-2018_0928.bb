...
SRC_URI = " \
    ...
    ${LULA_DL_URL}/brcmfmac4359-pcie.RSDB.enabled.zip${LULA_DL_PARAMS};name=update \
    ...
    file://wl \
"
SRC_URI[bundle.md5sum] = "434a22e56e7886cdc78f69b8f567ac6c"
SRC_URI[bundle.sha256sum] = "765c09410cc0661be6860806de1296305cd9ab8598c501fb0762ba58e59868bb"
SRC_URI[update.md5sum] = "fe1444d6d6e854885a392773a59279b1"
SRC_URI[update.sha256sum] = "397827a58cf589d30ae855626d2d7fd03519b748f256969c179b3cf78a0c83b8"
...
do_install() {
    ...
    # Update FW files
    cp -f ${WORKDIR}/brcmfmac4359-mfg* ${WORKDIR}/firmware/
    cp -f ${WORKDIR}/brcmfmac4359-prod-pcie.bin.bin ${WORKDIR}/firmware/brcmfmac4359-pcie.bin
    cp -f ${WORKDIR}/brcmfmac4359-prod-pcie.clm_blob ${WORKDIR}/firmware/brcmfmac4359-pcie.clm_blob
