...
PR = "r0"
PV = "W16.68.1.p195-C4X16623"
MRVL_PV = "W16.68.1.p195-16.26.1.p195-C4X16623"

MODULE_NAME = "jody-w2"
POSTFIX = "sdiouart"
MODULE_IDENTITY = "${MODULE_NAME}-${POSTFIX}"
FW_VER = "W16.68.1.p195"
BT_FW_VER = "16.26.1.p195"
DRIVER_VER = "C4X16623"
INSTALLDIR = "/opt/${MODULE_NAME}/${POSTFIX}"

#SD-WLAN-UART-BT-8987-U16-MMC-W16.68.1.p195-16.26.1.p195-C4X16623-MGPL.zip

SRC_URI = " \
    ${LULA_DL_URL}/SD-WLAN-UART-BT-8987-U16-MMC-${MRVL_PV}-MGPL.zip${LULA_DL_PARAMS};name=bundle \
...
"
SRC_URI[bundle.md5sum] = "1c17640aa7fbcb3f70acf118c21209e1"
SRC_URI[bundle.sha256sum] = "039fb5c3f59c7050be4885e837051a02eb050fb238bf7318a8c1b796ce53cabe"

S = "${WORKDIR}/SD-UAPSTA-UART-BT-8987-U16-MMC-${MRVL_PV}-MGPL"
