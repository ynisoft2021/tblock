...
PR = "r2"
PV = "16.68.10.p15-C4X16639"
MRVL_PV = "16.68.10.p15-16.26.10.p15-C4X16639"

MODULE_NAME = "jody-w2"
POSTFIX = "sdio"
MODULE_IDENTITY = "${MODULE_NAME}-${POSTFIX}"
FW_VER = "16.68.10.p15"
BT_FW_VER = "16.26.10.p15"
DRIVER_VER = "C4X16639"
INSTALLDIR = "/opt/${MODULE_NAME}/${POSTFIX}"

SRC_URI = " \
    ${LULA_DL_URL}/SD-WLAN-SD-BT-8987-U16-MMC-W${MRVL_PV}-MGPL.zip${LULA_DL_PARAMS};name=bundle \
    file://${MRVL_PV}/0001-adapt-to-kernel-3.10.patch \
...
"
SRC_URI[bundle.md5sum] = "7bbe4a4125002176b398dd478d0fb690"
SRC_URI[bundle.sha256sum] = "98003b21e17d0a7d68756222a8cd7c383d1366b3cb6a1b24942e245d38ad546e"

S = "${WORKDIR}/SD-UAPSTA-BT-8987-U16-MMC-W${MRVL_PV}-MGPL"
...
do_extract_sources() {
    ...
    cd SD-WLAN-SD-BT-8987-U16-MMC-W${MRVL_PV}-MGPL
    for i in *.tgz; do
        tar -xzf ${i}
    done
    cp -rf SD-UAPSTA-BT-8987-U16-MMC-W${MRVL_PV}-MGPL ../
    cp -rf FwImage ../
}
