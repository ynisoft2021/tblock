...
SRC_URI = " \
    ${LULA_DL_URL}/SD-UAPSTA-BT-8787-U16-MMC-${PV}_AX-GPL.zip${LULA_DL_PARAMS};name=bundle \
...
"
SRC_URI[bundle.md5sum] = "52689d5004a056fe650fbdd37567e57a"
SRC_URI[bundle.sha256sum] = "006b2224e4b617208f2ff8aea7cf687c1d1bb698edfbf64c1f5dd97d90e1e926"

S = "${WORKDIR}/SD-UAPSTA-BT-8787-U16-MMC-${PV}_AX-GPL"
